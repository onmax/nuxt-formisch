...
AutoForm generates complete forms from Valibot schemas automatically. Define your schema once and get a working form with validation, proper input types, and Nuxt UI styling.
...
See the [AutoForm guide](/guide/auto-form) for field types, schema metadata, slots, and customization options.
...
`useForm`, `useField`, `useFieldArray`, `useFormFields`, `useNuxtUIField`

### Components

`FForm`, `FField`, `FFieldArray`, `AutoForm`, `AutoFormField`, `AutoFormObject`, `AutoFormArray`
